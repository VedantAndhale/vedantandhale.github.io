...
### HTML icons
If you would like to customize the icons, you 
...
The default can be overridden by defining a value to the `icon` key in your 
...
#  - { ... } # Repeat for each additional icon you want to add
```

In this format, the keys are identical to their HTML representations.

If you plan to add multiple icons generated by a website (see list below), it
may be easier to define it as HTML. Here is an example which appends the 
**Apple touch icon** to Amethyst's default icon:
...
This second icon will now be used as a web page icon when someone adds your 
webpage to the home screen of their Apple device. If you are interested in more 
information about the current and past standards of icons, you can read 
[this article](https://www.emergeinteractive.com/insights/detail/the-essentials-of-icons/).

**Note** that all generated icon paths, defined by the `href` 
